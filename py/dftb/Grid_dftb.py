...
Role in CompChemUtils: in-process DFTB+ SCF + matrix export for OpenCL grid/STM projection (`py.dftb.Grid_dftb`).
Uses `LCAO_grid.cl` + `LCAO_STM.cl` kernels (ported from SPAMMM).
...
import time
from py.ocl.OpenCLBase import OpenCLBase
