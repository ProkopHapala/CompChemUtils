...
Usage:
    from py.dftb import DFTBcore
    from py import config_loader as cfg

    dftb = DFTBcore(libpath=cfg.dftbcore_lib())
    dftb.init('h2o.hsd')
...
class DFTBcore:
    ...
    def __init__(self, libpath=None):
        ...
        dftbplus_lib = os.path.join(os.path.dirname(libpath), 'libdftbplus.so')
